...
const translationProjectName = 'design4pro';
const translationExtensionName = 'vscode-workspace-manager';
...
const defaultLanguages = [
    ...
    { id: 'pl', folderName: 'pl', transifexId: 'pl_PL' }
];
...
gulp.task('_dev-build', gulp.series(doBuild(false, false)));
